...
import 'mini_widgets/bio_chemical_diagnosis_main_categories_header.dart';

class BioChemicalDiagnosisMainCategoriesView
    extends GetView<BioChemicalDiagnosisController> {
  const BioChemicalDiagnosisMainCategoriesView({super.key});
    ...
    return Scaffold(
      body: BackgroundContainer(
        child: RefreshIndicator(
          ...
          child: Column(
            children: [
              const BioChemicalDiagnosisMainCategoriesHeader(),
      ...
      if (controller.mainListItems.isEmpty) {
        return const Center(
          child: Padding(
            ...
            child: Text(
              'No biochemical emergencies found',
              style: TextStyle(
                color: Colors.white,
                fontSize: 16,
      ...
      return SymptomSelectionWidget(
        ...
        onSymptomTap: (item) async {
          ...
          if (isCategory) {
            ...
            Get.toNamed('/bio-chemical-diagnosis-subcategories', arguments: {
              'mainCategory': item,
            });
          } else {
